...
Version  : 0.17.0
Release  : 61
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/ranger_0.17.0.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/ranger_0.17.0.tar.gz
...
%package dev
Summary: dev components for the R-ranger package.
Group: Development
Requires: R-ranger-lib = %{version}-%{release}
Provides: R-ranger-devel = %{version}-%{release}
Requires: R-ranger = %{version}-%{release}

%description dev
dev components for the R-ranger package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731648851
...
/usr/lib64/R/library/ranger/tests/testthat/test_hshrink.R
...
/usr/lib64/R/library/ranger/tests/testthat/test_missings.R
/usr/lib64/R/library/ranger/tests/testthat/test_nodestats.R
/usr/lib64/R/library/ranger/tests/testthat/test_poissonsplit.R
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/ranger/libs/ranger.so
/V4/usr/lib64/R/library/ranger/libs/ranger.so
